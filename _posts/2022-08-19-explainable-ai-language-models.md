...
{% include elements/figure.html image="/img/explainable-ai-post/gradient-explain.png" caption="Gradient-based method to visualize the importance of the input words for the next word prediction (India)" %}
